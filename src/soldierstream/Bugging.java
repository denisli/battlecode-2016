	...
	public void move() throws GameActionException {
		if (hugging == Hugging.NONE) {
			...
			if (rc.canMove(dir)) {
				...
				// Since we can't move closer to the destination, we should commence hugging.
				...
				// Pick the hugging which gives the least distance towards the destination
			...
			if (hugging == Hugging.LEFT) {
				...
				// If the direction is fan = 1 away from the direction it came from,
				...
				if (getFanDist(dirToDest, cameFromDir) > 1) {
